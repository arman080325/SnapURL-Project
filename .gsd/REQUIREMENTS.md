...
|----|-------------|--------|--------|
| REQ-01 | Setup Node.js + Express + TypeScript environment with strict configuration and script tooling | SPEC Goal 1 | Pending |
| REQ-02 | Setup SQLite database with `better-sqlite3`, WAL mode, indexing, and URL repository layer | SPEC Goal 1 | Pending |
